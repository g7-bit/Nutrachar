...
function Diet() {
  ...
  function calculateTotalMacros(data) {
    ...
    if(totalMacros){
      ...
      console.log("calculated total macros::  output", totalMacros);
    }
  ...
  async function convertInMultiplier(data) {
    ...
    console.log("convertedInMultiplier", convertedData);
     setMultiplierArr(convertedData); // state Update
  }

  // useEffect(() => {
  //   calculateTotalMacros(currentData);
  // }, [currentData]);

  function handleOnChange(value, fname) {
    console.log("fname:: ", fname);
    console.log("value:: ", value);
    console.log("handleOnchange ::og InitialData,  ", currentData);
    const modifiedData = currentData.map((foodObj) => {
                  ...
                  {Object.keys(foodObj)
                    ...
                    .map((foodItem) =>
                      foodItem === "foodName" ? (
                        ...
                        <td key={foodItem} className="text-center overflow-x-auto w-300 ">
